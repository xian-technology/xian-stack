...
PUBLISHERS = (
    ...
    TrustedPublisher(
        project="xian-tech-runtime-types",
        owner="xian-technology",
        repository="xian-contracting",
        workflow="release.yml",
    ...
    TrustedPublisher(
        project="xian-tech-compiler-core",
        owner="xian-technology",
        repository="xian-contracting",
        workflow="release.yml",
        environment="pypi-xian-compiler-core",
    ),
    TrustedPublisher(
        project="xian-tech-zk",
        owner="xian-technology",
        repository="xian-contracting",
        workflow="release.yml",
        environment="pypi-xian-zk",
    ),
    TrustedPublisher(
        project="xian-tech-abci",
        owner="xian-technology",
