...
XIAN_BDS_ENABLED=1 XIAN_PUBLIC_QUERY_ENABLED=1 XIAN_POSTGRAPHILE_HOST=0.0.0.0 docker compose --profile integrated -f docker-compose-abci.yml -f docker-compose-abci-bds.yml config -q
