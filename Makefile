...
XIAN_PY_DIR ?= ../xian-py
XIAN_DEX_BUNDLE ?= ../xian-dex/contract-bundle.json
...
XIAN_TX_FEE_MODE ?= paid_metered
XIAN_FREE_TX_MAX_CHI ?= 1000000
XIAN_FREE_BLOCK_MAX_CHI ?= 20000000
...
XIAN_BDS_CATCHUP_ENABLED_FLAG = $(if $(filter $(FALSE_VALUES),$(XIAN_BDS_CATCHUP_ENABLED)),--no-bds-catchup-enabled,--bds-catchup-enabled)
...
XIAN_PUBLIC_MONITORING_ENABLED ?= 0
XIAN_MONITORING_PUBLIC_AUTH_CONFIRMED ?= 0
XIAN_REQUIRE_DIGEST_PINNED_THIRD_PARTY_IMAGES ?= 0
...
XIAN_APP_METRICS_ENABLED_FLAG = $(if $(filter $(FALSE_VALUES),$(XIAN_APP_METRICS_ENABLED)),--no-metrics-enabled,--metrics-enabled)
...
XIAN_POSTGRES_IMAGE ?= postgres:17.10
XIAN_PROMETHEUS_IMAGE ?= prom/prometheus:v3.12.0
XIAN_PROMETHEUS_CONFIG ?= ./monitoring/prometheus/integrated.yml
XIAN_PROMETHEUS_HOST ?= 127.0.0.1
XIAN_PROMETHEUS_PORT ?= 9090
XIAN_GRAFANA_IMAGE ?= grafana/grafana:12.4.5
...
XIAN_POSTGRAPHILE_REQUIRED_TABLES ?= addresses,bds_meta,blocks,contracts,events,rewards,shielded_output_tags,shielded_outputs,state,state_changes,state_patches,transactions
...
XIAN_LOCALNET_PARALLEL_EXECUTION_MAX_SPECULATIVE_WAVES ?= 4
XIAN_LOCALNET_PARALLEL_EXECUTION_MIN_WAVE_ACCEPTANCE_RATIO ?= 0.25
XIAN_LOCALNET_PARALLEL_EXECUTION_LOW_ACCEPTANCE_MIN_WAVE_SIZE ?= 8
XIAN_LOCALNET_PARALLEL_EXECUTION_WARM_WORKERS ?= 1
XIAN_LOCALNET_PARALLEL_EXECUTION_ACCESS_ESTIMATES_ENABLED ?= 1
...
export XIAN_TX_FEE_MODE := $(XIAN_TX_FEE_MODE)
export XIAN_FREE_TX_MAX_CHI := $(XIAN_FREE_TX_MAX_CHI)
export XIAN_FREE_BLOCK_MAX_CHI := $(XIAN_FREE_BLOCK_MAX_CHI)
...
export XIAN_PUBLIC_MONITORING_ENABLED := $(XIAN_PUBLIC_MONITORING_ENABLED)
export XIAN_MONITORING_PUBLIC_AUTH_CONFIRMED := $(XIAN_MONITORING_PUBLIC_AUTH_CONFIRMED)
export XIAN_REQUIRE_DIGEST_PINNED_THIRD_PARTY_IMAGES := $(XIAN_REQUIRE_DIGEST_PINNED_THIRD_PARTY_IMAGES)
...
export XIAN_POSTGRES_IMAGE := $(XIAN_POSTGRES_IMAGE)
...
export XIAN_DASHBOARD_ENABLED := $(XIAN_DASHBOARD_ENABLED)
...
export XIAN_POSTGRAPHILE_STATEMENT_TIMEOUT_MS := $(XIAN_POSTGRAPHILE_STATEMENT_TIMEOUT_MS)
export XIAN_POSTGRAPHILE_BODY_SIZE_LIMIT_BYTES := $(XIAN_POSTGRAPHILE_BODY_SIZE_LIMIT_BYTES)
export XIAN_POSTGRAPHILE_DISABLE_DEFAULT_MUTATIONS := $(XIAN_POSTGRAPHILE_DISABLE_DEFAULT_MUTATIONS)
export XIAN_POSTGRAPHILE_SIMPLE_COLLECTIONS := $(XIAN_POSTGRAPHILE_SIMPLE_COLLECTIONS)
export XIAN_POSTGRAPHILE_SCHEMA_WAIT_TIMEOUT_SECONDS := $(XIAN_POSTGRAPHILE_SCHEMA_WAIT_TIMEOUT_SECONDS)
export XIAN_POSTGRAPHILE_REQUIRED_TABLES := $(XIAN_POSTGRAPHILE_REQUIRED_TABLES)
...
export XIAN_LOCALNET_PARALLEL_EXECUTION_MAX_SPECULATIVE_WAVES := $(XIAN_LOCALNET_PARALLEL_EXECUTION_MAX_SPECULATIVE_WAVES)
export XIAN_LOCALNET_PARALLEL_EXECUTION_MIN_WAVE_ACCEPTANCE_RATIO := $(XIAN_LOCALNET_PARALLEL_EXECUTION_MIN_WAVE_ACCEPTANCE_RATIO)
export XIAN_LOCALNET_PARALLEL_EXECUTION_LOW_ACCEPTANCE_MIN_WAVE_SIZE := $(XIAN_LOCALNET_PARALLEL_EXECUTION_LOW_ACCEPTANCE_MIN_WAVE_SIZE)
export XIAN_LOCALNET_PARALLEL_EXECUTION_WARM_WORKERS := $(XIAN_LOCALNET_PARALLEL_EXECUTION_WARM_WORKERS)
export XIAN_LOCALNET_PARALLEL_EXECUTION_ACCESS_ESTIMATES_ENABLED := $(XIAN_LOCALNET_PARALLEL_EXECUTION_ACCESS_ESTIMATES_ENABLED)
...
LOCALNET_E2E_TRANSFER_FANOUT_OPS ?= 160
LOCALNET_E2E_CONTRACT_HEAVY_OPS ?= 96
LOCALNET_E2E_THROUGHPUT_WALLET_COUNT ?= 16
LOCALNET_E2E_THROUGHPUT_SUBMIT_WORKERS ?= 32
LOCALNET_E2E_CONTRACT_HEAVY_ROUNDS ?= 32
...
LOCALNET_E2E_PARALLEL_EXECUTION_ACCESS_ESTIMATES_ENABLED ?= $(XIAN_LOCALNET_PARALLEL_EXECUTION_ACCESS_ESTIMATES_ENABLED)
...
print-env:
	...
	@printf "XIAN_TX_FEE_MODE=%s\n" "$(XIAN_TX_FEE_MODE)"
	@printf "XIAN_FREE_TX_MAX_CHI=%s\n" "$(XIAN_FREE_TX_MAX_CHI)"
	@printf "XIAN_FREE_BLOCK_MAX_CHI=%s\n" "$(XIAN_FREE_BLOCK_MAX_CHI)"
	...
	@printf "XIAN_PUBLIC_MONITORING_ENABLED=%s\n" "$(XIAN_PUBLIC_MONITORING_ENABLED)"
	@printf "XIAN_MONITORING_PUBLIC_AUTH_CONFIRMED=%s\n" "$(XIAN_MONITORING_PUBLIC_AUTH_CONFIRMED)"
	@printf "XIAN_REQUIRE_DIGEST_PINNED_THIRD_PARTY_IMAGES=%s\n" "$(XIAN_REQUIRE_DIGEST_PINNED_THIRD_PARTY_IMAGES)"
	...
	@printf "XIAN_POSTGRAPHILE_STATEMENT_TIMEOUT_MS=%s\n" "$(XIAN_POSTGRAPHILE_STATEMENT_TIMEOUT_MS)"
	@printf "XIAN_POSTGRAPHILE_BODY_SIZE_LIMIT_BYTES=%s\n" "$(XIAN_POSTGRAPHILE_BODY_SIZE_LIMIT_BYTES)"
	@printf "XIAN_POSTGRAPHILE_DISABLE_DEFAULT_MUTATIONS=%s\n" "$(XIAN_POSTGRAPHILE_DISABLE_DEFAULT_MUTATIONS)"
	@printf "XIAN_POSTGRAPHILE_SIMPLE_COLLECTIONS=%s\n" "$(XIAN_POSTGRAPHILE_SIMPLE_COLLECTIONS)"
	@printf "XIAN_POSTGRAPHILE_SCHEMA_WAIT_TIMEOUT_SECONDS=%s\n" "$(XIAN_POSTGRAPHILE_SCHEMA_WAIT_TIMEOUT_SECONDS)"
	@printf "XIAN_POSTGRAPHILE_REQUIRED_TABLES=%s\n" "$(XIAN_POSTGRAPHILE_REQUIRED_TABLES)"
...
dashboard-build dashboard-up dashboard-bds-up dashboard-fidelity-build dashboard-fidelity-up: XIAN_DASHBOARD_ENABLED := 1
...
localnet-e2e:
	...
	uv run --project "$(XIAN_PY_DIR)" --with "$(XIAN_CONTRACTING_DIR)" --python "$(XIAN_STACK_PYTHON)" python3 ./scripts/localnet-e2e.py \
		...
		--transfer-fanout-ops $(LOCALNET_E2E_TRANSFER_FANOUT_OPS) \
		--contract-heavy-ops $(LOCALNET_E2E_CONTRACT_HEAVY_OPS) \
		--throughput-wallet-count $(LOCALNET_E2E_THROUGHPUT_WALLET_COUNT) \
		--throughput-submit-workers $(LOCALNET_E2E_THROUGHPUT_SUBMIT_WORKERS) \
		--contract-heavy-rounds $(LOCALNET_E2E_CONTRACT_HEAVY_ROUNDS) \
